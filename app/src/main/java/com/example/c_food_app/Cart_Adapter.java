...
public class Cart_Adapter extends ArrayAdapter<Cart> {
    ...
    public Cart_Adapter(@NonNull Context context, ArrayList cart_list, Activity activity) {
    ...
    @Override
    public int getPosition(@Nullable Cart item) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(cart_view==null){
            cart_view = LayoutInflater.from(getContext()).inflate(R.layout.cart_layout, parent,false);
...
//        Button order_btn =(Button) total_view.findViewById(R.id.order_btn);
        imageView.setImageBitmap(cart.getImg_bitmap());
        desc.setText("Description: "+cart.getDescription());
