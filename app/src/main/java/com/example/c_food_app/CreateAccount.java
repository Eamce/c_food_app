            ...
            public void onClick(View view) {
                try{
                    if(checkFields()){
                        ...
                        cv.put("name",AES.encrypt(Server.key,name.getText().toString()).toString());
                        cv.put("password",AES.encrypt(Server.key,password_r.getText().toString()).toString());
                        cv.put("email",AES.encrypt(Server.key,emailadd.getText().toString()).toString());
                        cv.put("phone",AES.encrypt(Server.key,contact.getText().toString()).toString());
